...
* RDBMS is a Relational DataBase Management System. It is the model that SQL and other database systems are build on.
1. Why do tables need a `primary key`?
* A primary key ensures that there is a unique item in every row, and allows forming relations with other tables.
1. What is the name given to a table column that references the primary key on another table.
* Foreign key.
1. What do we need in order to have a _many to many_ relationship between two tables.
* To have a many to many relationship, we need a third table. This table acts as a go-between for the other two tables and has a one to many relationship with each of the other tables.
